...
<div class="container-fluid page-body-wrapper vendor-dashboard d-flex pt-5 pb-5">
  ...
  <div class="sidebar">
    ...
    <ul>
      ...
      <li data-id="{{$merchent->id}}" class="merchant-item"><u>{{$merchent->first_name}}</u>
    ...
    <div class="message-avatar ms-3">
      ...
      <div class="message-content">
        <div class="message-bubble bg-white p-2 rounded">
            ${userData.msg_image 
                ? `<img src="${window.location.origin + '/public/uploads/chat/' + userData.msg_image}" alt="" class="image_fluid">
