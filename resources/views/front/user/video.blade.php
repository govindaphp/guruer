...
<div class="container-fluid page-body-wrapper vendor-dashboard d-flex pt-5 pb-5 video-customer-page"> 
  <!-- Sidebar -->
...
<!--     <a class="nav-link" href="{{url('chatRoom')}}?meetingId={{$meeting_id}}">
        <i class="fa fa-comment"></i>
          <span class="menu-title">Join Video Chat</span>
