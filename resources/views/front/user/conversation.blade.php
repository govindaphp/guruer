  ...
  @foreach ($chats as $chat)
      @if ($chat->sender_id != $customer->id)
          ...
          <div class="d-flex justify-content-start mb-4 side-left-chat">
            <div class="img_cont_msg">
                <img src="{{$merchent->profile_image==''? url('/public').'/front_assets/images/reviw1.png': url('/public').'/admin/uploads/user/'.$merchent->profile_image}}" alt="Receiver Avatar" class="rounded-circle user_img">
              </div>
      ...
      @else
          ...
          <div class="d-flex justify-content-end mb-4 side-right-chat">
            ...
            <div class="img_cont_msg">
              <img src="{{$customer->profile_image==''? url('/public').'/front_assets/images/reviw1.png': url('/public').'/admin/uploads/user/'.$customer->profile_image}}" alt="Sender Avatar" class="rounded-circle user_img">
            </div>
          </div>
      @endif
