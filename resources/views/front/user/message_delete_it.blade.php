            ...
            <div class="card mb-sm-3 mb-md-0 contacts_card">
                <div class="card-header">
                    <div class="input-group">
                        <input type="text" placeholder="Search..." name="" class="form-control search" id="keyword-text" />
...
<div id="modalBox" class="modal">
    <div class="modal-content">
        ...
        <div class="image-select-user">
            ...
            <img class="inner-images" id="previewImage" src="public/admin/uploads/user/men-three.jpg" alt="Recent Preview">
        </div>
...
var dynamicValue = sessionStorage.getItem('dynamicValue'); // Retrieve the stored value
    if (dynamicValue) {
        $(".merchant-item[data-id='" + dynamicValue + "']").trigger("click");
        sessionStorage.removeItem('dynamicValue'); // Optionally clear it after use
    }
});
